...
class RCSRUserOperationViewController: UIViewController {
    private var dependency: RCSRUserOperationDependency
    weak var delegate:RCSRUserOperationProtocol?
    ...
    init(dependency: RCSRUserOperationDependency,
